                            ...
                            <div id="customerList">
                                <div class="row g-4 mb-3">
                                    ...
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ url('/add-category') }}" class="btn btn-success add-btn"><i
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort">#</th>
                                                <th class="sort">Category Image</th>
                                                <th class="sort">Category Name</th>
                                                <th class="sort">Category Url</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($category as $key => $row)
                                                <tr class="">
                                                    ...
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        <img src="{{ asset($row->category_image) }}" class="img-circle"
                                                            style="height: 50px; width: 50px;border-radius:50%;object-fit: cover;object-position: 100%;"
                                                            alt="">
                                                    </td>
                                                    <td class="email">{{ $row->category_name }}</td>
                                                    <td class="date">{{ $row->category_url }}</td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="{{ url('/add-category/' . $row->id) }}"
